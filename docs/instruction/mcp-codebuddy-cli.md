...
```powershell
$ardufluxPath = (Get-ChildItem "$env:USERPROFILE\.vscode\extensions\DonkeyDrift.arduflux-*\dist\mcpServer.js" | Select-Object -First 1).FullName
...
```bash
ls ~/.vscode/extensions/DonkeyDrift.arduflux-*/dist/mcpServer.js | head -1
```
